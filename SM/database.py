...
class WorkspaceData:
    def __init__(self):
        ...
        self.cursor.execute("CREATE TABLE IF NOT EXISTS industries(username TEXT ,place TEXT,industryname TEXT,industryaddress TEXT,quantity TEXT,price REAl)")
        self.cursor.execute("CREATE TABLE IF NOT EXISTS stubble(username TEXT,address TEXT,stubblename TEXT,date TEXT,quan TEXT,phonenumber REAL,industryname TEXT,industryaddress TEXT)")
        self.conn.commit()
